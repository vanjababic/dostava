...
insert into "narudzbina" (id, ukupnacena, datum, objekat_id, kupac_id, statusNarudzbine_id) values (nextval('seq_narudzbina'), 2140,'2021-07-06', null,  1, 1);

insert into "narudzbinaproizvodi" (id, kolicina, narudzbina_id, proizvod_id) values (nextval('seq_narudzbinaProizvodi'), 1, 1, 1);
insert into "narudzbinaproizvodi" (id, kolicina, narudzbina_id, proizvod_id) values (nextval('seq_narudzbinaProizvodi'), 2, 1, 2);
